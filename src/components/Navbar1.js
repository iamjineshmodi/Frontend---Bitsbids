...
export default function SearchAppBar({username,email,icon}) {
  ...
  return (<>
    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <AppBar position="static" sx={{backgroundColor:'#0f1A43'}}>
        ...
        <Button onClick={ ()=>{navigate('/upload')}}>Upload My Product</Button>
      ...
      <Box sx={{display:'flex',width:'100%',justifyContent:'right',}}>
            ...
            <img src={icon} style={{borderRadius:"50%",height:"40px"}} alt="" />             
